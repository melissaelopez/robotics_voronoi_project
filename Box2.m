...
classdef Box2 < Box1
    ...
    properties
        type;			% = FREE/MIXED/STUCK
%         featuresCor = {};		% set of corner features
%         featuresEdge = {}; % set of edge features
        features = {};
        classification;
    ...
    methods
        ...
        function showFeatures(obj)
            disp('Corner features are :');
            disp('X :');
            obj.featuresCor{1}
            disp('Y :');
            obj.featuresCor{2}
            disp('Edge features are :');
            for i = 1:length(obj.featuresEdge)
                obj.featuresEdge{i}
            end
        end
       
        % split() 	- Duplicating code from Box1 should be a better way
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
